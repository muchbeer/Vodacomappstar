...
import king.muchbeer.vodacomappstar.login.MainCategoryActivity;
import king.muchbeer.vodacomappstar.user.NewProductActivity;
import king.muchbeer.vodacomappstar.user.ViewCategoryActivity;
				...
				try {
					if (json.getString(KEY_SUCCESS) != null) {
						...
						if(Integer.parseInt(res) == 1){
							...
							Intent dashboard = new Intent(getApplicationContext(), ViewCategoryActivity.class);
