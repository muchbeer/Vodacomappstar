...
public class NewElectronicsActivity extends Activity {
	...
	private static String url_create_product = "http://www.aac2014-tzmarketplace.appspot.com/create_electronics.php";
	...
	class CreateNewProduct extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(NewElectronicsActivity.this);
